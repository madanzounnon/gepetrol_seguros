...
class CodePinConrfirmerScreen extends StatefulWidget {
  static String routeName = "/CodePinConrfirmer";
  String? acode;
  ...
  @override
  _CodePinConrfirmerScreenState createState() =>
      _CodePinConrfirmerScreenState();
}

class _CodePinConrfirmerScreenState extends State<CodePinConrfirmerScreen> {
  var selectedindex = 0;
  String code = '';
                                  ...
                                  child: TextButton(
                                      ...
                                      onPressed: () async {
                                        if (code.length == 5 &&
                                            widget.acode == code) {
                                          bool resu =
                                              await StoreAuth().saveCode(code);

                                          if (resu) {
                                            Utile.messageSuccess(context,
                                                "Votre code PIN spécifique a été bien défini, Entre le code pour déverrouiller");
                                            Navigator.pushReplacementNamed(
                                                context,
                                                CodePinLoginScreen.routeName);
                                          }
                                        } else {
